classdef ImageRotate
    ...
    methods
        function obj = ImageRotate(varargin)
            % Default vals.
            obj.p           = 0.5;
            obj.magnitude   = 170;
        ...
        function [imgAugmented, varargout] = apply(obj, img, isConsistent, varargin)
            ...
            if isConsistent
                ...
                if isApply
                    [imgAugmented, params, gtOut] = imageRotate(obj,img,K,y,f1,f2,params);
                ...
                if rand > (1 - obj.p)
                    [imgAugmented, ~, gtOut] = imageRotate(obj,img,K,y,f1,f2);
                    varargout{2} = gtOut;
                else
                    imgAugmented = img;
                end
        ...
        function [imgAugmented, varargout] = imageRotate(obj,img,K,y,fModPose,fModPts,varargin)
            % Input parsing
            nStaticArgs = 6;
            ...
            if isRandom                
                eulChange = (rand(1,1) - 0.5).*obj.magnitude;
            ...
            R_change = euler_to_so3(0, 0, eulChange);
            M = K*R_change/K;
